...
import { ContractAtFuture, ContractDeploymentFuture, ContractFuture, IgnitionModuleResult } from "@nomicfoundation/ignition-core";
...
type LookupContractReturnTypeForContractName<ContractName extends keyof ArtifactsMap> = GetContractReturnType<ArtifactsMap[ContractName]["abi"]>;
...
export type AbiOf<ContractDeploymentFutureT> = ContractDeploymentFutureT extends ContractDeploymentFuture<infer ContractDepploymentAbiT> ? ContractDepploymentAbiT : ContractDeploymentFutureT extends ContractAtFuture<infer ContractAbiT> ? ContractAbiT : never;
export {};
//# sourceMappingURL=ignition-module-results-to-viem-contracts.d.ts.map